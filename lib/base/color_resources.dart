...
class ColorResources {
  static const Color getPrimary = Color(0XFF8cc63f);

  static const Color getGreyColor = Color(0xFFA0A4A8);

  static const Color getGrayColor = Color(0xFF6E6E6E);

  static const Color getSearchBg = Color(0xFFF4F7FC);

  static const Color getBackgroundColor = Color(0xFFF4F7FC);

  static const Color getHintColor = Color(0xFF52575C);

  static const Color getGreyBunkerColor = Color(0xFF25282B);
