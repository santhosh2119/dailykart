...
//
//     final recentlyviewed = recentlyviewedFromJson(jsonString);

import 'dart:convert';

Recentlyviewed recentlyviewedFromJson(String str) =>
    Recentlyviewed.fromJson(json.decode(str));

String recentlyviewedToJson(Recentlyviewed data) => json.encode(data.toJson());
