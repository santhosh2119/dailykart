...
import 'package:daily_kart/screens/products/child_category_products_screen.dart';
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ChildCategoryProductsScreen(
                      title: product["child_category_name"],
                      catId: catId,
                      subCatId: subCatId,
                      childCatId: product["child_cat_id"].toString(),
                    )),
          );
